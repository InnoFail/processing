class keyboard{
  ...
  for(int i=0;i<5;i++){
    ...
    if(help.mOnce()){
      ...
      }else if(this.u.c(i).c(j).default_text.equals("_")){
        this.character=this.character+" ";
      }else if(this.u.c(i).c(j).default_text.equals(" ")){
        if(this.character.length()!=0){
        this.character=this.character.substring(0,this.character.length()-1);
        }
      }else if(this.u.c(i).c(j).default_text.equals(">")){
        this.character=this.character+"";
      }else if(this.u.c(i).c(j).default_text.equals("-")){
